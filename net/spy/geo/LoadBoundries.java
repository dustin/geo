 ...
 */
public class LoadBoundries extends Object {
	 ...
	 */
	public LoadBoundries(File attributesFile, File polyFile)
		throws Exception {
		super();
	...
	public Polygon nextPolygon() throws Exception {
		...
		while(line!=null && !line.startsWith("END")) {
			poly.addElement(parsePoint(line));
			line=polySource.readLine();
		}
		return(poly);
	}
	...
	public static void main(String args[]) throws Exception {
		...
		LoadBoundries lb=new LoadBoundries(fat, f);

		SpyDB db=new SpyDB(new GeoConfig());
